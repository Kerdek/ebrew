...
/* Check that calls to mq_open with O_CREAT set have an appropriate third and fourth
   parameter.  */
extern mqd_t mq_open (const i8 *__name, i32 __oflag, ...)
     __THROW __nonnull ((1));
extern mqd_t __mq_open_2 (const i8 *__name, i32 __oflag)
     __THROW __nonnull ((1));
extern mqd_t __REDIRECT_NTH (__mq_open_alias, (const i8 *__name,
					       i32 __oflag, ...), mq_open)
     __nonnull ((1));
...
__NTH (mq_open (const i8 *__name, i32 __oflag, ...))
{
