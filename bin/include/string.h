...
/* Copy SRC to DEST.  */
export extern strcpy (__restrict __dest@char __restrict __src@const char)@char 
     __THROW __nonnull ((1, 2));
/* Copy no more than N characters of SRC to DEST.  */
export extern strncpy (__restrict __dest@char
		      __restrict __src@const char __n size_t)@char 
     __THROW __nonnull ((1, 2));

/* Append SRC onto DEST.  */
export extern strcat (__restrict __dest@char __restrict __src@const char)@char 
     __THROW __nonnull ((1, 2));
/* Append no more than N characters from SRC onto DEST.  */
export extern strncat (__restrict __dest@char __restrict __src@const char
...
export extern strxfrm (__restrict __dest@char
		       __restrict __src@const char __n size_t)size_t
     __THROW __nonnull ((2));
...
export extern "C++"
{
export extern strpbrk (__s@char __accept@ const char)@char 
     __THROW __asm ("strpbrk") __attribute_pure__ __nonnull ((1, 2));
export extern strpbrk (__s@const char __accept@ const char)@const char 
     __THROW __asm ("strpbrk") __attribute_pure__ __nonnull ((1, 2));

# ifdef __OPTIMIZE__
__extern_always_inline char *
strpbrk (__s@char __accept@ const char) __THROW
{
  return __builtin_strpbrk (__s, __accept);
}

__extern_always_inline const char *
strpbrk (__s@const char __accept@ const char) __THROW
{
  return __builtin_strpbrk (__s, __accept);
}
# endif
...
export extern "C++"
{
export extern strstr (__haystack@char __needle@ const char)@char 
     __THROW __asm ("strstr") __attribute_pure__ __nonnull ((1, 2));
export extern strstr (__haystack@const char __needle@ const char)@const char 
     __THROW __asm ("strstr") __attribute_pure__ __nonnull ((1, 2));

# ifdef __OPTIMIZE__
__extern_always_inline char *
strstr (__haystack@char __needle@ const char) __THROW
{
  return __builtin_strstr (__haystack, __needle);
}

__extern_always_inline const char *
strstr (__haystack@const char__needle@ const char) __THROW
{
  return __builtin_strstr (__haystack, __needle);
}
# endif
...
export extern strtok (__restrict __s@char __restrict __delim@const char)@char 
     __THROW __nonnull ((2));

/* Divide S into tokens separated by characters in DELIM.  Information
   passed between calls are stored in SAVE_PTR.  */
export extern __strtok_r (__restrict __s@char
			 __restrict __delim@const char
			 __restrict __save_ptr@@char)@char 
     __THROW __nonnull ((2, 3));
#ifdef __USE_POSIX
export extern strtok_r (__restrict __s@char __restrict __delim@const char
		       __restrict __save_ptr@@char)@char 
     __THROW __nonnull ((2, 3));
#endif
...
# ifdef __CORRECT_ISO_CPP_STRING_H_PROTO
export extern "C++" @strcasestr (__haystack@char,__needle@ const char)char
     __THROW __asm ("strcasestr") __attribute_pure__ __nonnull ((1, 2));
export extern "C++" strcasestr (__haystack@const char,__needle@
				     const char)@const char
     __THROW __asm ("strcasestr") __attribute_pure__ __nonnull ((1, 2));
# else
export extern strcasestr (__haystack@const char,__needle@ const char)@char 
     __THROW __attribute_pure__ __nonnull ((1, 2));
# endif
#endif
...
export extern strsep (char **__restrict __stringp
		     __restrict __delim@const char)@char 
     __THROW __nonnull ((1, 2));
#endif
...
export extern __stpcpy (__restrict __dest@char __restrict __src@const char)@char 
     __THROW __nonnull ((1, 2));
export extern stpcpy (__restrict __dest@char __restrict __src@const char)@char 
     __THROW __nonnull ((1, 2));

/* Copy no more than N characters of SRC to DEST, returning the address of
   the last character written into DEST.  */
export extern __stpncpy (__restrict __dest@char
			__restrict __src@const char __n size_t)@char 
     __THROW __nonnull ((1, 2));
export extern stpncpy (__restrict __dest@char
		      __restrict __src@const char __n size_t)@char 
     __THROW __nonnull ((1, 2));
#endif
...
export extern strfry (__string@char)@char  __THROW __nonnull ((1));
...
/* Return the file name within directory of FILENAME.  We don't
   ...
   available.  */
#  ifdef __CORRECT_ISO_CPP_STRING_H_PROTO
export extern "C++" char *basename (__filename@char)
     __THROW __asm ("basename") __nonnull ((1));
export extern "C++" const char *basename (__filename@const char)
     __THROW __asm ("basename") __nonnull ((1));
#  else
export extern basename (__filename@const char)@char  __THROW __nonnull ((1));
#  endif
# endif
#endif
