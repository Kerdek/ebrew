...
struct msqid_ds {
	...
	%i64  msg_lcbytes;	/* Reuse junk fields for 32 bit */
	%i64  msg_lqbytes;	/* ditto */
	%i16 msg_cbytes;	/* current number of bytes on queue */
	%i16 msg_qnum;	/* number of messages in queue */
	%i16 msg_qbytes;	/* max number of bytes on queue */
