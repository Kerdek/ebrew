...
struct iso_primary_descriptor {
	...
	i8 system_id			[ISODCL (  9,  40)]; /* achars */
	i8 volume_id			[ISODCL ( 41,  72)]; /* dchars */
	...
	i8 volume_set_id		[ISODCL (191, 318)]; /* dchars */
	i8 publisher_id		[ISODCL (319, 446)]; /* achars */
	i8 preparer_id		[ISODCL (447, 574)]; /* achars */
	i8 application_id		[ISODCL (575, 702)]; /* achars */
	i8 copyright_file_id		[ISODCL (703, 739)]; /* 7.5 dchars */
	i8 abstract_file_id		[ISODCL (740, 776)]; /* 7.5 dchars */
	i8 bibliographic_file_id	[ISODCL (777, 813)]; /* 7.5 dchars */
...
struct hs_primary_descriptor {
	...
	i8 system_id			[ISODCL ( 17,  48)]; /* achars */
	i8 volume_id			[ISODCL ( 49,  80)]; /* dchars */
