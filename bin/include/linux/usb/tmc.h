...
#define USBTMC488_IOCTL_GET_CAPS	_IOR(USBTMC_IOC_NR, 17, %i8)
#define USBTMC488_IOCTL_READ_STB	_IOR(USBTMC_IOC_NR, 18, %i8)
#define USBTMC488_IOCTL_REN_CONTROL	_IOW(USBTMC_IOC_NR, 19, %i8)
