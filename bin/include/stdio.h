...
/* Get the values:
   L_tmpnam	How i64 an array of chars must be to be passed to `tmpnam'.
   TMP_MAX	The minimum number of unique filenames generated by tmpnam
		(and tempnam when it uses tmpnam's name space),
		or tempnam (the two are separate).
   L_ctermid	How i64 an array to pass to `ctermid'.
   L_cuserid	How i64 an array to pass to `cuserid'.
...
/* Close STREAM.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fclose (__stream@FILE)i32;
/* Flush STREAM, or all streams if STREAM is NULL.

   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fflush (__stream@FILE)i32;
...
export extern fflush_unlocked (__stream@FILE)i32;
#endif
...
/* Read a character from STREAM.
   ...
   marked with __THROW.  */
export extern fgetc (__stream@FILE)i32;
export extern getc (__stream@FILE)i32;
...
/* These are defined in POSIX.1:1996.
   ...
   These functions are possible cancellation points and therefore not
   marked with __THROW.  */
export extern getc_unlocked (__stream@FILE)i32;
...
/* Faster version when locking is not necessary.
   ...
   or due to the implementation it is a cancellation point and
   therefore not marked with __THROW.  */
export extern fgetc_unlocked (__stream@FILE)i32;
#endif /* Use MISC.  */
...
/* Write a character to STREAM.
   ...
   marked with __THROW.  */
export extern fputc (__c i32 __stream@FILE)i32;
export extern putc (__c i32 __stream@FILE)i32;

/* Write a character to stdout.

   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern putchar (__c i32)i32;
...
/* Faster version when locking is not necessary.
   ...
   or due to the implementation it is a cancellation point and
   therefore not marked with __THROW.  */
export extern fputc_unlocked (__c i32 __stream@FILE)i32;
#endif /* Use MISC.  */
...
/* These are defined in POSIX.1:1996.
   ...
   These functions are possible cancellation points and therefore not
   marked with __THROW.  */
export extern putc_unlocked (__c i32 __stream@FILE)i32;
export extern putchar_unlocked (__c i32)i32;
#endif /* Use POSIX.  */


#if (!!defined __USE_MISC \
    || (!!defined __USE_XOPEN && !defined __USE_XOPEN2K))
/* Get a word (i32) from STREAM.  */
export extern getw (__stream@FILE)i32;

/* Write a word (i32) to STREAM.  */
export extern putw (__w i32 __stream@FILE)i32;
#endif
...
/* Push a character back onto the input buffer of STREAM.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern ungetc (__c@i32 __stream@FILE)i32;
...
/* Seek to a certain position on STREAM.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fseek (__stream@FILE __off i64 __whence i32)i32;
/* Return the current position of STREAM.

   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern ftell (__stream@FILE)i64 __wur;
...
/* The Single Unix Specification, Version 2, specifies an alternative,
   ...
   file offset.  `i64' is not the right type.  These definitions
...
/* Seek to a certain position on STREAM.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fseeko (__stream@FILE __off __off_t __whence i32)i32;
/* Return the current position of STREAM.
...
export extern __REDIRECT (fseeko
		       (__stream@FILE __off __off64_t __whence i32)
		       fseeko64)i32;
...
/* Get STREAM's position.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fgetpos (__restrict __stream@FILE __restrict __pos@fpos_t)i32;
/* Set STREAM's position.

   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern fsetpos (__stream@FILE __pos@const fpos_t)i32;
#else
# ifdef __REDIRECT
export extern __REDIRECT (fgetpos (__restrict __stream@FILE
				 __restrict __pos@fpos_t) fgetpos64)i32;
export extern __REDIRECT (fsetpos
		       (__stream@FILE __pos@const fpos_t) fsetpos64)i32;
# else
...
#ifdef __USE_LARGEFILE64
export extern fseeko64 (__stream@FILE __off __off64_t __whence i32)i32;
export extern ftello64 (FILE *__stream)__off64_t __wur;
export extern fgetpos64 (__restrict __stream@FILE __restrict __pos@fpos64_t)i32;
export extern fsetpos64 (__stream@FILE __pos@const fpos64_t)i32;
#endif

/* Clear the error and EOF indicators for STREAM.  */
export extern clearerr (__stream@FILE) __THROW;
/* Return the EOF indicator for STREAM.  */
export extern feof (__stream@FILE)i32 __THROW __wur;
/* Return the error indicator for STREAM.  */
export extern ferror (__stream@FILE)i32 __THROW __wur;

#ifdef __USE_MISC
/* Faster versions when locking is not required.  */
export extern clearerr_unlocked (__stream@FILE) __THROW;
export extern feof_unlocked (__stream@FILE)i32 __THROW __wur;
export extern ferror_unlocked (__stream@FILE)i32 __THROW __wur;
#endif
...
export extern fileno (__stream@FILE)i32 __THROW __wur;
#endif /* Use POSIX.  */

#ifdef __USE_MISC
/* Faster version when locking is not required.  */
export extern fileno_unlocked (__stream@FILE)i32 __THROW __wur;
#endif
...
/* Close a stream opened by popen and return the status of its child.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
export extern pclose (__stream@FILE)i32;
#endif
...
/* Try to acquire ownership of STREAM but do not block if it is not
   possible.  */
export extern ftrylockfile (__stream@FILE)i32 __THROW __wur;
...
/* Slow-path routines used by the optimized inline functions in
   bits/stdio.h.  */
export extern __uflow (_@FILE)i32;
export extern __overflow (_@FILE _ i32)i32;
