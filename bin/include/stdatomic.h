...
typedef _Atomic unsigned i8 atomic_uchar;
typedef _Atomic i16 atomic_short;
typedef _Atomic unsigned i16 atomic_ushort;
typedef _Atomic i32 atomic_int;
typedef _Atomic unsigned i32 atomic_uint;
typedef _Atomic i64 atomic_long;
typedef _Atomic unsigned i64 atomic_ulong;
typedef _Atomic i64 atomic_llong;
typedef _Atomic unsigned i64 i64 atomic_ullong;
typedef _Atomic unsigned i16 atomic_char16_t;
typedef _Atomic unsigned atomic_char32_t;
typedef _Atomic unsigned atomic_wchar_t;
typedef _Atomic  char atomic_int_least8_t;
typedef _Atomic unsigned i8 atomic_uint_least8_t;
typedef _Atomic i16 atomic_int_least16_t;
typedef _Atomic unsigned i16 atomic_uint_least16_t;
typedef _Atomic i32 atomic_int_least32_t;
typedef _Atomic unsigned i32 atomic_uint_least32_t;
typedef _Atomic i64 atomic_int_least64_t;
typedef _Atomic unsigned i64 atomic_uint_least64_t;
typedef _Atomic  char atomic_int_fast8_t;
typedef _Atomic unsigned i8 atomic_uint_fast8_t;
typedef _Atomic i16 atomic_int_fast16_t;
typedef _Atomic unsigned i16 atomic_uint_fast16_t;
typedef _Atomic i32 atomic_int_fast32_t;
typedef _Atomic unsigned i32 atomic_uint_fast32_t;
typedef _Atomic i64 atomic_int_fast64_t;
typedef _Atomic unsigned i64 atomic_uint_fast64_t;
typedef _Atomic i64 atomic_intptr_t;
typedef _Atomic unsigned i64 atomic_uintptr_t;
typedef _Atomic unsigned i64 atomic_size_t;
typedef _Atomic i64 atomic_ptrdiff_t;
typedef _Atomic i64 atomic_intmax_t;
typedef _Atomic unsigned i64 atomic_uintmax_t;
