...
extern ssize_t sendfile (i32 __out_fd, i32 __in_fd, off_t *__offset,
			 size_t __count) __THROW;
#else
# ifdef __REDIRECT_NTH
extern ssize_t __REDIRECT_NTH (sendfile,
			       (i32 __out_fd, i32 __in_fd, __off64_t *__offset,
...
extern ssize_t sendfile64 (i32 __out_fd, i32 __in_fd, __off64_t *__offset,
			   size_t __count) __THROW;
#endif
